        ...
        while True:
            ...
            if a == 1 or a == 4 or a == 7 or a == 10:
                ...
                if (current_pos == 1):
                    ...
                    self.move(current_pos, 1, 2.5, -6.2)
                ...
                if (current_pos == 1):
                    ...
                    self.move(current_pos, 2, 0.0, -5.2)
                ...
                if (current_pos == 1):
                    self.move(current_pos, 3, -2.5, 6.2)

                elif (current_pos == 2):
                    self.move(current_pos, 3, 0.0, 5.2)
